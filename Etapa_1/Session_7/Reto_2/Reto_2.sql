##################################        Nota        ###########################################
#
#   Lo hice así porque no podía cargar los datos completos desde Workbench ya que tardaría días.
#   Desde terminal hice lo siguiente.
#  
#################################################################################################
...
#Usando como base el archivo ratings.dat, limpiarlo e importar los datos en la tabla ratings creada en el Reto 1.
